...
function inicarApp() {
    mostrarSeccion();
    tabs(); //Camia la sección cuando se presiones los tabs
...
function mostrarResumen() {
    ...
    servicios.forEach( servicio => {
        ...
        textoPrecio.innerHTML = `<span>Precio:</span> $${precio}` ;
    ...
    const horaFecha = document.createElement('P');
    horaFecha.innerHTML = `<span>Hora:</span> ${hora} horas`;
